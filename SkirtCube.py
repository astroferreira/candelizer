...
class SkirtCube():
    ...
    def __init__(self, filename, base_path, z=None, z0=0.002265, reference_size=319,
        ...
        self.pixel_size = self.FOV * u.kpc * COSMO.arcsec_per_kpc_comoving(self.z0)/self.reference_size
    ...
    def _load(self):
        ...
        with fits.open(self.cube_path, mode='readonly') as hdul:
            ...
            self.data = (self.data / self.wav).to(self.out_units).T
